<template>
    <div class="form-area card border p-2">
        <div class="mb-3">
            ...
            <input type="text" v-model="userData.title" class="form-control" id="title" placeholder="Doküman">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <textarea type="text" v-model="userData.description" class="form-control" id="description" placeholder="Bu var ya..."></textarea>
        </div>
